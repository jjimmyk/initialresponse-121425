...
export default function App() {
  ...
  const [showCopCard, setShowCopCard] = useState(true);
  ...
  const [selectedPlanningWorkflow, setSelectedPlanningWorkflow] = useState<string>('');
  const [operationalPeriodEndDate, setOperationalPeriodEndDate] = useState<string>('');
  ...
  const renderCurrentPhase = (hideRecommendActions = false, addActionButtonText?: string, isMapView = false) => {
    ...
    switch (displayedPhase.id) {
      ...
      case 'incident-roster':
        return <IncidentRosterPhase {...commonProps} isMapExpanded={showCopCard} />;
      case 'resources':
    ...
    <div className="h-screen bg-background text-foreground flex flex-col overflow-hidden">
      ...
      <div className="relative bg-black h-16 w-full flex-shrink-0">
        ...
        <div className="absolute content-stretch flex gap-4 items-center justify-start left-0 top-0 h-16">
          ...
          {/* Incident Name Badge - Only show when not in map view */}
          {!showFullscreenMap && (
            <>
              <div className="inline-flex items-center justify-center px-4 py-2 rounded-md backdrop-blur-sm" style={{ backgroundColor: 'rgba(167, 139, 250, 0.2)', border: '1px solid rgba(167, 139, 250, 0.3)' }}>
        ...
        <div className="absolute content-stretch flex gap-4 h-16 items-center justify-end right-4 top-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => { setShowFullscreenMap(true); setMapPanelDock('left'); setBottomPanelCollapsed(false); }}
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 p-6 flex flex-col overflow-hidden">
              <div className={`flex-1 flex gap-6 overflow-hidden transition-all duration-300`}>
                ...
                <div className={`flex flex-col overflow-hidden ${showFullscreenMap && showCopCard ? 'w-1/2' : 'w-full'}`}>
        ...
        <div className="fixed inset-0 z-50 bg-black">
          ...
          {rightPanelCollapsed && (
            <div
              ...
              style={{ top: '80px', right: 0, height: '405px', width: '32px', backgroundColor: '#000000' }}
          ...
          {mapPanelDock === 'left' && showMapChat && chatFloatingBottom && (
            <div
              ...
              style={{ left: 'calc(33.3333vw + 16px)', bottom: '16px', width: '540px', maxWidth: 'calc(66.6667vw - 32px)' }}
            >
          ...
          <div className="absolute top-4 right-4 z-[100] flex items-center gap-3">
            ...
            <Button
              variant="ghost"
              size="sm"
              onClick={() => { setShowFullscreenMap(false); setMapPanelDock('left'); setBottomPanelCollapsed(false); }}
          ...
          {isSelectingOnMap && (
            <div
              ...
              style={
                mapPanelDock === 'left'
                  ? (leftPanelCollapsed ? { top: 0, left: '5vw', right: 0, bottom: 0 } : { top: 0, right: 0, bottom: 0, left: '33.3333vw' })
                  : { top: 0, left: 0, right: 0, height: bottomPanelCollapsed ? 'calc(100vh - 24px)' : '60vh' }
              }
              onClick={(e) => {
          ...
          {mapPanelDock === 'left' ? (
            <>
              {!leftPanelCollapsed && (
                <div className="absolute top-0 bottom-0 left-0 border-r border-border" style={{ width: '33.3333vw' }}>
              ...
              <div
                className="flex-none border-t border-border bg-muted/20 overflow-hidden"
                 style={{ height: showMapChat ? '40%' : 'auto' }}
              >
                 {showMapChat ? (
            ...
            <>
              {!bottomPanelCollapsed ? (
                <div className="absolute bottom-0 border-t border-border" style={{ left: 0, right: '7%' }}>
                  <div className="relative flex flex-col bg-background" style={{ height: '40vh' }}>
                    {/* Header */}
                    <div className="border-b border-border flex-shrink-0">
                      <div className="flex items-center justify-between">
                        <PlanningPStepper
                          ...
                          leftAddon={
                            <div
                              className="inline-flex items-center justify-center h-8 px-3 rounded-md text-sm font-medium pointer-events-none select-none mr-2"
                    ...
                    <div className="flex-1 min-h-0 overflow-hidden">
                      {showMapChat ? (
                        <div className="h-full flex overflow-hidden">
                          <div className="min-w-0 overflow-y-auto p-6" style={{ width: '67%' }}>
                            {renderCurrentPhase()}
                          </div>
                          <div className="bg-card border-l border-border flex flex-col" style={{ width: '33%' }}>
                ...
                <div
                  className="absolute bottom-0 z-40 cursor-pointer opacity-80 hover:opacity-100"
                  style={{ left: 0, right: '7%', height: '24px', backgroundColor: '#000000' }}
